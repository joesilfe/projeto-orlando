...
class Frete {
	...
	public function __construct(
		...
		$this->xml = simplexml_load_file(
			Frete::URL."nCdEmpresa=0&sDsSenha=0&sCepOrigem=".$CEPorigem."&sCepDestino=".$CEPdestino."&nVlPeso=".$peso."&nCdFormato=1&nVlComprimento=".$comprimento."&nVlAltura=".$altura."&nVlLargura=".$largura."&sCdMaoPropria=n&nVlValorDeclarado=".$valor."&sCdAvisoRecebimento=n&nCdServico=".Frete::SERVICE."&nVlDiametro=0&StrRetorno=xml");
