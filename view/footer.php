				...
				<div class="container">
					<div class="row">
						<div class="col-md-2 text-center hidden-xs">
							<img class="logotipo" src="img/orlando-logo.png" alt="orlando-logo">
						</div>
						<div class="col-md-10">
							<div class="row row-cols">
								...
								<div class="col-md-4 col-get-in-touch">
									...
									<address class="hidden-xs">
										<i class="fas fa-map-marker"></i> <span>618 E. South ?Street, suite 510 <br> Orlando, FL 32801</span>
									</address>

									<p class="hidden-xs"><a href="tel:1855ORLCITY"><i class="fas fa-phone"></i> 1.855.ORL.CITY</a></p>

									<div class="row hidden-sm hidden-md hidden-lg">
										<div class="col-xs-6">
											<a href="#" class="btn btn-footer"><i class="fas fa-map-marker"></i> Location</a>
										</div>
										<div class="col-xs-6">
											<a href="#" class="btn btn-footer"><i class="fas fa-phone"></i> Call</a>
										</div>
									</div>									
									...
									<ul class="list-unstyled list-socials">
										...
										<li class="hidden-sm hidden-md hidden-lg" id="page-up"><a href="#" target="_blank"><i class="fas fa-angle-up"></i></a></li>
									</ul>	
								</div>
							</div>
						</div>
